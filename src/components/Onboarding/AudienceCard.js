...
/** Ensure value is a string safe to render (backend may send objects e.g. { demographics, psychographics, searchBehavior }). */
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: 16 }}>
        {toDisplayString(targetSegment) && (
          <Text strong style={{ display: 'block', marginBottom: 4, color: 'var(--color-text-primary)' }}>{toDisplayString(targetSegment)}</Text>
        )}
