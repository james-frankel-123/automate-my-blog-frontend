...
| **Worker queue & progress** | Worker queue & progress | Content generation progress bar/step label, website analysis progress bar, 503 queue unavailable, retry modal on job failure, **posts and credits load in parallel** on dashboard mount. |
